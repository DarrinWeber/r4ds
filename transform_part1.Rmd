---
title: 'Chapter 5: Data transformation Part 1'
...
* `matches("(.)\\1")`: selects variables that match a regular expression.
   ...
   learn more about regular expressions in the strings section.
